...
//    private static final String topCardUrl = "https://api.linkedin.com/v1/people/~?format=json";
    private static final String topCardUrl = "https://api.linkedin.com/v1/people/~:(formatted-name,phone-numbers,industry,positions)?format=json";
...
//        navigation_view.setNavigationItemSelectedListener(this);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UserProfile.this, LinkedInNewActivity.class);
