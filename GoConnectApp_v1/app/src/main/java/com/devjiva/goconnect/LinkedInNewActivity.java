...
public class LinkedInNewActivity extends Activity {
    private static final String TAG = LinkedInNewActivity.class.getSimpleName();
    public static final String PACKAGE = "com.devjiva.goconnect";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linkedin_new);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Intent intent = new Intent(LinkedInNewActivity.this, UserProfile.class);
    ...
    public void generateHashkey() {
        try {
            ...
            for (Signature signature : info.signatures) {
                ...
                ((TextView) findViewById(R.id.hash_key)).setText(hash);
                Log.d(TAG, "packageName=" + info.packageName + "hash_key=" + hash);
            }
