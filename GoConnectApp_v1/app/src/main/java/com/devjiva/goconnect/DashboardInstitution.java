...
@SuppressLint("NewApi")
public class DashboardInstitution extends SwipeActivity implements OnClickListener {

    //    private GestureDetectorCompat gestureDetectorCompat;
    private Intent intent;
    private LinearLayout layout100Meters, layout1km, layout10km, layoutFurther, userInstitutionLogoLayout;
    ...
    private TextView userInstitutionName;
...
//        onPause();
        Intent intent = new Intent(DashboardInstitution.this, SettingsActivity.class);
...
//        finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_institution_new);
...
//        SingletonUtil.getSingletonConfigInstance().isConnectedToInternet(this);
        ...
        userInstitutionLogoLayout = (LinearLayout) findViewById(R.id.user_institution_logo_layout);
        ...
        userInstitutionLogoLayout.setLayoutParams(mlayoutParams);
        ...
        userInstitutionName.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16);
        userInstitutionName.setOnClickListener(this);
        intent = getIntent();
        if (intent != null) {
                        ...
                        if (sharedPreference.getBoolValueWithKey(getApplicationContext(), "SwtShareSafe")) {
                            if (getNearCallCount == 0) {
                                if (jsonOjectNearUser != null) {
                                    ...
                                    Toast.makeText(DashboardInstitution.this, "Unable to fetch data!!Please try again", Toast.LENGTH_SHORT).show();
                                }
                            }

                        } else
                            Toast.makeText(DashboardInstitution.this, "Plese turn on the sharemode to view users", Toast.LENGTH_SHORT).show();
...
//                SingletonUtil.getSingletonConfigInstance().showErrorDialog(this);
        ...
        try {
            ...
            try {
                ...
                userInstitutionName.setText(jsonOject.getJSONObject("user").getJSONObject("position").get("organisationName").toString());
            } catch (JSONException e) {
                e.printStackTrace();
            }
        ...
        findViewById(R.id.txt_institution_face).setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent intent = new Intent(DashboardInstitution.this, Dashboard.class);
        ...
        findViewById(R.id.txt_institution_topic).setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent intent = new Intent(DashboardInstitution.this, DashboardTopic.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                intent.putExtra("nearUserDataObject", nearUserDataObject);
                startActivity(intent);
            }
...
//        gestureDetectorCompat = new GestureDetectorCompat(this, new My2ndGestureListener());
        ...
        for (int i = 0; i < dataSize; i++) {
            ...
            if (dataSizeTemp < rowLimit) {
                try {
                    ...
                    View mLinearLayout = inflater.inflate(R.layout.institution_view_sample, null);
                    ...
                    TextView txtView = (TextView) mLinearLayout.findViewById(R.id.institution_name);
                    txtView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16);
                    txtView.setText(otherUserJSONObject.getJSONObject("position").get("organisationName").toString());
            ...
            if (dataSizeTemp == rowLimit) {
                ...
                if (i == 9) {
                    ...
                    tv.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            // TODO Auto-generated method stub
                            Intent intent = new Intent(DashboardInstitution.this, MoreUsersActivity.class);
                            startActivity(intent);
                        }
                    });
                    ll.addView(tv);
    ...
    private void showBusinessCardOfOtherUser(JSONObject otherUserJSONObject) {
        onStop();
        Intent intent = new Intent(DashboardInstitution.this, BusinessCardOtherUserActivity.class);
        Bundle b = new Bundle();
    ...
    private void showBusinessCardOfCurrentUser() {
        onStop();
        Intent intent = new Intent(DashboardInstitution.this, BusinessCardUserActivity.class);
        startActivity(intent);
    }
